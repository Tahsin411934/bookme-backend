<x-app-layout>
    <div class="container w-[95%] mx-auto">
        <h1 class="text-2xl font-bold mb-4">Service Category: </h1>
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-50">
                        <form action="{{ route('service_categories.update', $category->category_id) }}" method="POST" class="update-form">
                            ...
                            <td>
                                <textarea name="" class="w-full border border-gray-300 rounded px-2 py-1 resize-none" disabled>{{ $category->category_id }}</textarea>
                            </td>
                            <td>
                            ...
                            <td>
                                <textarea name="description" class="w-full border border-gray-300 rounded px-2 py-1 resize-none" disabled>{{ ($category->description) }}</textarea>
                            </td>
                            <td>
                                <textarea name="isactive" class="w-full border border-gray-300 rounded px-2 py-1 resize-none" disabled>{{ ($category->isactive) }}</textarea>
                            </td>
                            ...
                            <td class="flex space-x-2">
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('service_categories.destroy', $category->category_id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
